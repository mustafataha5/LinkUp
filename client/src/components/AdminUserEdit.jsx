        ...
        <Container>
            <TableContainer component={Paper}>
                <Table>
                    <TableHead>
                        <TableRow> 
                            <TableCell style={{ fontWeight: 'bold', fontSize: '18px' }}>User Name</TableCell>
                            <TableCell style={{ fontWeight: 'bold', fontSize: '18px' }}>Active/Deactive</TableCell>
                            <TableCell style={{ fontWeight: 'bold', fontSize: '18px' }}>Edit Profile</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {users.map((user, i) => (
                            <TableRow key={i}>
                                ...
                                <TableCell>
                                    ...
                                    <a href={`/profile/${user._id}`} target="_blank" rel="noopener noreferrer" className='btn btn-secondary'>Edit</a>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
